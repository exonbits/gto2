...
int main(int argc, char *argv[])
{
  ...
  "                                                                          \n"
  "      [gto2_aa_decompressor]                                              \n"
  "          It decompresses the result of gto2_aa_compressor.               \n"
  "                                                                          \n"
  "      [gto2_aa_from_fa]                                                   \n"
  ...
  "          It pipeline aligns the end of single reads.                     \n"
  "                                                                          \n"
  "      [gto_align_reads.sh]                                                \n"
  "          It pipeline aligns FASTQ reads with trim, sort, duplications    \n" 
  "          removal, indexes and consensus.                                 \n"
  "                                                                          \n"
  "COPYRIGHT                                                                 \n"
